...
let rectLength: number = 30; //centi meters
let rectWidth: number = 15; //centi meters
...
let circleRadius: number = 20; //centi meters
...
let cubeLength: number = 40; //centi meters
...
let temp_In_Fahrenheit: number = 108;
let temp_In_Celsius: number = 32;
...
let number_In_Seconds: number = 230;
...
let obtained_Marks: number = 945;
let total_Marks: number = 1100;
...
var myName: string = "Submitted by: Waleed Ahmad";
console.log(myName);